...
# static fields
.field private static zzbru:Lcom/google/firebase/iid/zzz;


# instance fields
.field private final zzbrv:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zzbrw:Ljava/lang/Boolean;

.field final zzbrx:Ljava/util/Queue;
...
.field private final zzbry:Ljava/util/Queue;
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzz;->zzbrv:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzz;->zzbrw:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzz;->zzbrx:Ljava/util/Queue;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzz;->zzbry:Ljava/util/Queue;
...
.method private final zzb(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzz;->zzbrv:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/iid/zzz;->zzbrv:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :cond_3
    :goto_0
    iget-object v2, p0, Lcom/google/firebase/iid/zzz;->zzbrv:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v2

    :try_start_1
    iget-object v3, p0, Lcom/google/firebase/iid/zzz;->zzbrv:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_5
    :try_start_2
    iget-object v1, p0, Lcom/google/firebase/iid/zzz;->zzbrw:Ljava/lang/Boolean;
    ...
    :cond_a
    iget-object v0, p0, Lcom/google/firebase/iid/zzz;->zzbrw:Ljava/lang/Boolean;
...
.method public static declared-synchronized zzta()Lcom/google/firebase/iid/zzz;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/zzz;->zzbru:Lcom/google/firebase/iid/zzz;
    ...
    sput-object v1, Lcom/google/firebase/iid/zzz;->zzbru:Lcom/google/firebase/iid/zzz;
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :pswitch_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzz;->zzbry:Ljava/util/Queue;

    goto :goto_2

    :pswitch_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzz;->zzbrx:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, p3}, Lcom/google/firebase/iid/zzz;->zzb(Landroid/content/Context;Landroid/content/Intent;)I
...
.method public final zztb()Landroid/content/Intent;
    .locals 1
